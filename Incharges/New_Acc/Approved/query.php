...
if ($department == 'Accountant_status') {
    $query = "SELECT * FROM status WHERE Accountant_status=1 AND HOD_status = '1' AND fine_status = '1' AND CC_status = '1' AND Library_HOD_status = '1' AND Sports_status = '1' AND TNP_status = '1' AND Scholarship_status = '1' ";
}
